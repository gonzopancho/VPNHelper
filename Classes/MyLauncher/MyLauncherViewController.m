...
-(void)launcherViewItemSelected:(MyLauncherItem*)item {
	...
	[controller.navigationItem setLeftBarButtonItem:
	 [[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"home_normal"] //@"launcher"
									  style:UIBarButtonItemStyleBordered 
									 target:self 
									 action:@selector(closeView)] autorelease]];
	*/ //previous left button method
	
	UIImage *imageNormal = [UIImage imageNamed:@"home_normal"];
	UIImage *imageHighlighted = [UIImage imageNamed:@"home_pressed"];
	...
	[leftButton setBackgroundImage:imageHighlighted forState:UIControlStateHighlighted];
	[leftButton addTarget:self action:@selector(closeView) forControlEvents:UIControlEventTouchUpInside];
	UIBarButtonItem *leftBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:leftButton];
	[controller.navigationItem setLeftBarButtonItem:leftBarButtonItem];
	...
	//[refreshButton release]; previous right button method
